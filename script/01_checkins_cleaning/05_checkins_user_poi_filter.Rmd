...
通过筛选poi和用户对checkins进行清洗和预处理，得到的数据可以直接用来进行计算绘图。
...
ifile_checkins <-
  "data/processed/01_checkins_cleaning/03_checkins_domestic.csv.gz"
odir_data <-
  "data/processed/"
odir_result <-
  "result/"
...
period_0 <-
  c(ymd("2018-10-01"):ymd("2020-02-01"))
...
fwrite(checkins_filter,
       paste0(odir_data, paste0("01_checkins.csv.gz")))
```
