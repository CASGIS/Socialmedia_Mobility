...
![](img/fig2.png){fig-align="center"}

###### Retail & recreation

![](img/fig3.png){fig-align="center"}

###### Parks

![](img/fig4.png){fig-align="center"}

###### Transit stations

![](img/fig5.png){fig-align="center"}

###### Grocery & pharmacy

![](img/fig6.png){fig-align="center"}
:::
...
# Download
<https://github.com/CASGIS/Socialmedia_Mobility/tree/main/publication/aggregated_geotagged_data>
...
Using the fine-grained Weibo mobility data should cite: XXX

<br>
<br>

# More details
Based on the fine-grained mobility data, our team performed the following analysis, which is described in the paper: XXX.
...
zhukaixin\@lreis.ac.cn <br>
wangjh\@lreis.ac.cn <br>
Team: <https://github.com/CASGIS> <br> 
<br> 
